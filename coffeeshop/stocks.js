...
const API_STOCKS = SERVER + 'stocksds.php?action=';
const API_PRODUCTOS = SERVER + 'productosds.php?action=readAll';
const API_COLORES = SERVER + 'coloresds.php?action=readAll';
