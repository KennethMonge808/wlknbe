...
const API_PRODUCTOS = SERVER + 'productosds.php?action=';
const ENDPOINT_CATEGORIAS = SERVER + 'categoriasds.php?action=readAll';
const ENDPOINT_TALLAS = SERVER + 'tallasds.php?action=readAll'; 
